...
res_dir='/path/to/your/CvG-Diff/logs'  # enter your directory for storing result
dataset_path='/path/to/your/dataset/aapm16/train_img' # enter your dataset path of train images
network='CvG-Diff'
